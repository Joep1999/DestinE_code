...
def build_training_data(date_str, series_nwp_forecast, series_nowcast_forecast, multi_model = True ):
    features = []
    ...
    # --- Domain averages ---
    series_average[key_nwp] = domain_average(series_nwp_forecast)
...
def run_machine_learning(destineE_datafolder, date_str, series_nwp_forecast, series_nowcast_forecast, multi_model, ):
    kmeans_number = 9
    BASE = Path(destineE_datafolder)
    prediction_features = build_training_data(date_str, series_nwp_forecast, series_nowcast_forecast, multi_model)
