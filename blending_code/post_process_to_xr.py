...
def convert_npy_to_nc_file(path_blend, path_nowcast,  metadata_blend, metadata_nowcast, path_nwp=None, metadata_nwp=None):
    ...
    blended_forectas = convert_input_to_xarray_dataset(
    ...
    blended_forectas.precip_intensity.attrs["transform"] = "No"

    blended_forectas.to_netcdf(path_blend[:-3] + 'nc')
    ...
    if path_nwp!= None:
        ...
        nwp_forecast.to_netcdf(blended_forectas[:-3] + '.nc')